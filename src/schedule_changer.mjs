...
export default async function schedule_changer(user_schedule){
    ...
    const short_summary = main("A person's typicaly daily schedule is as follows: " + times + ". Return, in AT MOST 2 sentences, a short summary describing the unhealthy activities in the schedule and how to change them.");
...
return healthy_dict, short_summary;
}